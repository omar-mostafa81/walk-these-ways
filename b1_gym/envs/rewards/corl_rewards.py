...
class CoRLRewards:
    ...
    def _reward_torques(self):
        # Penalize torques
        return torch.sum(torch.square(self.env.torques), dim=1) # B1 is almost 5 times lighter
    ...
    def _reward_feet_clearance_cmd_linear(self):
        ...
        target_height = self.env.commands[:, 9].unsqueeze(1) * phases + 0.04 # offset for foot radius 2cm B1 has a larger foot size
